...
{
    public class GetByIDAdmainUsersAssessmentResultQueryHandler
         : IRequestHandler<GetUsersAssessmentResultByIdAdmainQuery, AdmainReadUsersAssessmentResultDTO>
    {
        private readonly IRepository<UsersAssessmentResult> _repository;
        private readonly IIdentityService _identityService;
        private readonly IMapper _mapper;

        public GetByIDAdmainUsersAssessmentResultQueryHandler
        ...
        public async Task<AdmainReadUsersAssessmentResultDTO> Handle(GetUsersAssessmentResultByIdAdmainQuery request, CancellationToken cancellationToken)
        {
            var dto = await _repository.GetAll()
                 .Where(a => a.Id == request.id)
                 .ProjectTo<AdmainReadUsersAssessmentResultDTO>(_mapper.ConfigurationProvider)
