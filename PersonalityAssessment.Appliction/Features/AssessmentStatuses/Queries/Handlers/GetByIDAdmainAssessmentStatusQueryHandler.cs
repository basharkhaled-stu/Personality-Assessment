...
{
    public class GetByIDAdmainAssessmentStatusQueryHandler : IRequestHandler<GetAssessmentStatusesByIdAdmainQuery, AdmainReadAssessmentStatusDTO>
    {
        private readonly IRepository<AssessmentStatus> _repository;
        private readonly IMapper _mapper;
        public GetByIDAdmainAssessmentStatusQueryHandler(IRepository<AssessmentStatus> repository, IMapper mapper)
