...
{
    public class GetByIDAdmainUserAnswerQueryHandler
         : IRequestHandler<GetUserAnswerByIdAdmainQuery, AdmainReadUserAnswerDTO>
    {
        private readonly IRepository<UserAnswer> _repository;
        private readonly IIdentityService _identityService;
        private readonly IMapper _mapper;

        public GetByIDAdmainUserAnswerQueryHandler
        ...
        public async Task<AdmainReadUserAnswerDTO> Handle
            (GetUserAnswerByIdAdmainQuery request,
            CancellationToken cancellationToken)
        {
            var dto = await _repository.GetAll()
                .Where(a => a.Id == request.id)
                .ProjectTo<AdmainReadUserAnswerDTO>(_mapper.ConfigurationProvider)
