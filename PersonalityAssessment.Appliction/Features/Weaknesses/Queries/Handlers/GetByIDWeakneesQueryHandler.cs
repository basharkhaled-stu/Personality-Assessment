...
{
    public class GetByIDWeakneesQueryHandler : IRequestHandler<GetWeakneesByIdQuery, ReadWeakneesDTO>
    {
        private readonly IRepository<Weakness> _repository;
        private readonly IMapper _mapper;
        public GetByIDWeakneesQueryHandler(IRepository<Weakness> repository, IMapper mapper)
