...
namespace PersonalityAssessment.Core.Interface
{
    public interface IIdentityUser
    {
        ...
        Task<bool> UpdateProfileAsync(string userId, string? newUsername, string? firstName, string? lastName, string? newEmail, string? currentPassword, string? newPassword);

        // New: Get user profile
        Task<UserProfileData?> GetProfileAsync(string userId);
    }
}
