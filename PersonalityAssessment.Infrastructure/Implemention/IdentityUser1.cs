...
namespace PersonalityAssessment.Infrastructure.Implemention
{
            ...
            var claims = new List<Claim>
    {
        ...
        public async Task<PersonalityAssessment.Core.Admin.UserProfileData?> GetProfileAsync(string userId)
        {
            var user = await _User.FindByIdAsync(userId);
            if (user == null) return null;
            return new PersonalityAssessment.Core.Admin.UserProfileData
            {
                Id              = user.Id,
